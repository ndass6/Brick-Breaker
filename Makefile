...
OFILES = main.o mylib.o start.o text.o levels.o nextLevel.o loseLife.o gameOver.o ballPic.o wonGame.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h start.h text.h levels.h nextLevel.h loseLife.h gameOver.h ballPic.h wonGame.h
